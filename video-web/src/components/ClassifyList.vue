<template>
  <div>
    <el-divider content-position="left"> <p style="color: #00a1d6; font-family: '华文新魏'">从此无心爱良夜 任他明月下西楼</p> </el-divider>

    <el-row align="middle" type="flex" justify="center" style="flex-wrap: wrap">
      <el-col :lg="{ span:'4-8' }" v-for="(o) in 5" :key="o" :offset="0" style="justify-content:center;align-items:center;display:flex;">
        <div class="video-item" data-load-controls="true" data-time="00:20">
          <a href="/video-179847.html" target="_blank">
            <div class="video-box">
              <div class="video-vips-type">模板</div>
              <img class="lazy" data-original="//img95.699pic.com/video_cover/89/92/06/b_JT0FawedxUVP1620899206.jpg!/both/317x178" src="//img95.699pic.com/video_cover/89/92/06/b_JT0FawedxUVP1620899206.jpg!/both/317x178" alt="" style="display: block;">
              <video muted="" class="video-hover " data-original="//video.699pic.com/videos/89/92/20/b_RxUWQNieZnXQ1620899220_10s.mp4" loop="loop" width="100%" height="100%" src="//video.699pic.com/videos/89/92/20/b_RxUWQNieZnXQ1620899220_10s.mp4"></video>
            </div>
          </a>
          <a class="video-name fl" target="_blank" href="/video-179847.html" title="梦幻卡通儿童六一儿童节片头视频素材">
            <h3>梦幻卡通儿童六一儿童节片头</h3>
            <div class="type video-type4"><span></span></div>
          </a>
          <div class="video-option clearfix">
            <span class="icon-download fr down-btn-common down-from-know" data-downid="18" data-fetch-type="98" data-fetch-id="179847" video-op-type="download-video" video-op-id="179847" video-op-value="/download/video?id=179847" data-filetype="7" data-videorate="6"><i class="iconfont icon-liebiaoxiangqing-xiazaishu"></i>立即下载</span>
            <span class="video-collect fr " data-shou-id="179847"><i class="iconfont icon-liebiaoxiangqing-shoucangshu"></i></span>
          </div>
          <div class="progress-bar" style="display: none;">
            <div class="progress-slider" style="width: 105.667px;"></div>
          </div>
        </div>
      </el-col>
      <a class="recom-more-btn"><span>查看更多<span>同款</span>视频</span><i class="iconfont icon-jiantouxiao-you"></i></a>
    </el-row>

    <el-divider content-position="left"> <p style="color: #00a1d6; font-family: '华文新魏'">衣冠上国 礼仪之邦 </p></el-divider>
    ...
    <el-divider content-position="left"> <p style="color: #00a1d6; font-family: '华文新魏'"> 戏子多秋 可怜一处情深旧 </p></el-divider>
...
@media screen and (max-width: 1922px) and (min-width: 1470px) {
  .video-name .type.video-type8, .video-name .type.video-type4 {
    top: 10px;
  }
}

.video-name .type.video-type4 {
  background: url(//static.699pic.com/images/activity/4k8k.png) no-repeat 9px -50px;
  display: block;
  width: 30px;
  height: 21px;
  top: 8px;
...
.icon-liebiaoxiangqing-xiazaishu:before {
  content: "\e642";
}
...
.icon-liebiaoxiangqing-shoucangshu:before {
  content: "\e64e";
}
...
.video-option .icon-download:hover {
  background: #18BCEF;
}
